export function SiteFooter() {
  ...
  return (
    <footer className="mt-24 bg-gradient-to-b from-white via-[#f5fbf6] to-[#e6f7e6] py-16 text-foreground/90">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-12 px-6 md:flex-row md:justify-between">
        <div className="max-w-md space-y-4">
          ...
          <p className="text-xs text-foreground/60">© {new Date().getFullYear()} TalentHunt BD. All rights reserved.</p>
        </div>
